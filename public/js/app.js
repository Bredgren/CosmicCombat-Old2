...
(function() {
  var Camera, Character, DebugDraw, Game, H, ParticleSystem, Planet, Universe, W, b2Collision, b2Common, b2Contacts, b2Controllers, b2DebugDraw, b2Dynamics, b2Joints, b2Math, b2Shapes, b2Vec2, log_input, main, settings, stance,
  ...
  Character = (function() {
    ...
    function Character(universe, init_pos, type, click_callback) {
      var bodyDef, box, circle, stats,
        _this = this;

      this.universe = universe;
      if (type === settings.CHARACTERS.JACKIE) {
  ...
  Universe = (function() {
    ...
    Universe.prototype.newCharacter = function(options, click_callback) {
      ...
      character = new Character(this, pos, type, click_callback);
